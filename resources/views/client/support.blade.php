            ...
            <div class="accordion">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        Commandes en attente : {{ $pendingCount }} – En cours de traitement : {{ $processingCount }}.  
                        Pour les commandes expédiées, un numéro de suivi sera fourni pour suivre la livraison en temps réel.</p>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <p>Allez dans "Paramètres du compte" puis "Sécurité". Vous pourrez définir un nouveau mot de passe.  
                        Assurez-vous d'utiliser un mot de passe sécurisé combinant lettres, chiffres et symboles.</p>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <p>Si vous avez oublié votre mot de passe, utilisez l'option "Mot de passe oublié".  
                        Pour tout autre problème de connexion, contactez notre support via le chat ou l’e-mail fourni.</p>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <p>Nous acceptons les paiements par carte bancaire (Visa, MasterCard), Mobile Money et PayPal.  
                        Tous les paiements sont sécurisés grâce à notre système de cryptage.</p>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <p>Vous pouvez retourner un produit dans un délai de 14 jours après réception.  
                        Rendez-vous dans la section "Mes commandes" et cliquez sur "Retourner".  
                        Suivez ensuite les instructions pour l’expédition et le remboursement.</p>
                    </div>
                </div>

                <div class="accordion-item">
                    <div class="accordion-header">
                        <span>Comment contacter le support client ?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="accordion-content">
                        <p>Vous pouvez nous contacter via le chat en ligne sur le site, par e-mail à support@boutique.com ou par téléphone au +229 XX XX XX XX.  
                        Notre équipe est disponible du lundi au vendredi de 9h à 18h.</p>
                    </div>
                </div>
            </div>
        </section>
