        ...
        <section class="card cart">
            ...
            @foreach($cartItems as $item)
                @php
                    ...
                    $totale = $item->product->discount_price * $item->quantity;
                    $subtotal += $total;
                    $subtotale += $totale;
                @endphp
                ...
                <article class="item">
                    ...
                    <div class="meta">
                        <div>
                            ...
                            <div class="price">{{ number_format($price, 0, ',', ' ') }} FCFA</div>
                        </div>
    ...
    <div class="pill">
        ...
        <aside class="card summary">
            <div class="sum-card">
                ...
                <div class="line">
                    <span>Discount</span>
                    <strong style="color:#16a34a">{{ (($item->product->price - $item->product->discount_price)/$item->product->price)*100 }}%</strong>
                </div>
