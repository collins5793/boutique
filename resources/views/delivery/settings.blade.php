    ...
    <style>
        ...
        * {
        ...
        <section id="profil" class="section active">
            ...
            <form action="{{ route('livreur.settings.profile') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <section id="securite" class="section">
            <h2><i>🔒</i> Sécurité</h2>
            <form action="{{ route('livreur.settings.password') }}" method="POST">
                @csrf
                <div class="form-grid">
                    <div class="form-group">
        ...
        <section id="preferences" class="section">
            ...
            <form action="{{ route('livreur.settings.preferences') }}" method="POST">
                @csrf
                <div class="form-group">
