        ...
        <div class="product-image">
          ...
          <div class="product-badges">
            ...
            @if($product->discounts->count() > 0)
                <span class="badge bulk-discount" title="@foreach($product->discounts as $d) À partir de {{ $d->min_quantity }}: {{ number_format($d->price,0,',',' ') }} FCFA @if(!$loop->last), @endif @endforeach">
                    Réductions quantité
                </span>
            @endif
            ...
            @if($product->discounts->count() > 0)
                <ul class="bulk-discount-list">
                    @foreach($product->discounts as $d)
                        <li>À partir de {{ $d->min_quantity }}: {{ number_format($d->price, 0, ',', ' ') }} FCFA</li>
                    @endforeach
                </ul>
            @endif
        </div>
  ...
  <div class="modal-content-custom">
    ...
    <div class="modal-product-info">
      ...
      <div class="modal-reduction">
        <strong>reduction :</strong> <span id="modalProductreduction"></span>
      </div>
