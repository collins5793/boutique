    ...
    <div class="menu-container">
        <div class="menu-section">
            ...
            <ul class="menu">
                ...
                <li class="menu-item {{ request()->routeIs('delivery.pending') ? 'active' : '' }}">
                    <a href="{{ route('delivery.pending') }}" class="menu-link">
                        <div class="menu-icon"><i class="fas fa-box"></i></div>
                        <div class="menu-text">Comandes en attentes</div>
                        <div class="tooltip">Comandes en attentes</div>
                    </a>
                </li>
               <li class="menu-item {{ request()->routeIs('delivery.delivered-orders') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <ul class="menu">
                <li class="menu-item {{ request()->routeIs('livreur.settings') ? 'active' : '' }}">
                    <a href="{{ route('livreur.settings') }}" class="menu-link">
                        <div class="menu-icon"><i class="fas fa-cog"></i></div>
                        <div class="menu-text">Paramètres</div>
                        <div class="tooltip">Paramètres</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('livreur.support') ? 'active' : '' }}">
